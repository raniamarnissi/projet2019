...
?>
    <div class="container">
        <form action="confirmer.html" method="post">
            <div class="form-group">
                ...
                <!-- prix total -->
                <!-- <input name= "prixt" type="text" class="form-control" disabled value="<?=$_prixtotal?>"> -->
                statut delevry</br> 
                <select name="statut" id="statut" class="form-control">
                        <option value="1">livrer</option>
                        <option value="0">non livrer</option>
                </select>
                <!-- <button type="submit" name="valider" class="btn btn-outline-success"><a href="chariot.php">Valider</a></button>  -->
                <button type="submit" name="valider" class="btn btn-outline-success">valider</button>
                <button type="reset" name="annuler" class="btn btn-outline-danger"><a href="menu.php">Annuler</a></button>
