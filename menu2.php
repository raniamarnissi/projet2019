...
<?php
	...
	<div class="row mt-4">
		<div class="container">	<div class="row mt-4" style="margin-left:24px;">
    <table>
	<thead>
	<tr>
			    ...
			    <tr>
				    <td>
					<br>
					    <a href="login.php"><button class="btn btn-outline-success" type="submit" style="margin-left:90px;">Add to panier </button></a> &nbsp;&nbsp;
                        <br><br>
                    </td>
				</tr>	
		&nbsp;&nbsp;&nbsp;&nbsp;      
