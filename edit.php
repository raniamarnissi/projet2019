...
<head>
    ...
    <title>Editer produit  N°<?= $_GET['pid'] ?></title>
</head>
<body>
    <?php
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="firstname">Limage de produit :</label>
                            <img src = "<?php echo $data['fichier'] ?>" style="width:100px;height:100px;border-radius: 50%;" />
                            <input type="file" value="<?= $data['fichier'] ?>" required name="fichier" class="form-control" id="fichier">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
