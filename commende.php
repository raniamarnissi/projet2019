        ...
        <?php if (isset($_GET['notif'])): ?>
            <div class="alert alert-success alert-dismissible">
                ...
                <?php
                    ...
                    if ($_GET['notif'] == 'delete') echo 'commendes supprimé avec succés';
                ?>
            </div>
        <?php endif ?>
        <br>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                    ...
                    $listcommende = $commende->readAllCommende();
                    $data = $listcommende->fetchAll(); //une autre façon pour fetcher les données
                    // une autre façon pour ouvrir une structure entre le php et le HTML
                    //on ouvre la boucle avec les deux points(:)
                    foreach($data as $commendeData):
                    ?>
                        <tr>
                            <td><?= $commendeData['oid'] ?></td>   
                            <td><?= $commendeData['pid'] ?></td>   
                            <td><?= $commendeData['id'] ?></td> 
                            <td><?= $commendeData['quantite_produit'] ?></td>  
                            <td><?= $commendeData['odate'] ?></td>   
                            <td><?= $commendeData['statut_livraison'] ?></td>   
                            <td><?= $commendeData['vid'] ?></td>
                            <td>
                            
              
                            <td><a href='delete.php?oid=<?=$commendeData['oid']?>'<button type="submit" class="btn btn-danger">supprimer le commende</button></a> &nbsp;&nbsp;
