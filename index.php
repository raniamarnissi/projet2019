			...
			<div class="col-lg-7 col-md-6 about-right-w3 text-right py-md-5">
				<div class="right-space py-xl-5 py-lg-3">
					<div class="title-section mb-4">
						<h3 class="w3ls-title">Welcome to <span>Tasty Food</span></h3>
					</div>
			...
			<div class="row"> 
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="#menu.html">
								<img class="card-img-bottom" src="images/blog1.jpg" alt="Card image cap"style="width: 350px;  margin-left: 60px;" >
							</a>
						</div>
						<div class="card-body border border-top-0">
							<h5 class="blog-title card-title m-0" style="text-align: center;"><a href="#">French Burger</a></h5>
						</div>
					</div>
				</div> 
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="#menu.html">
								<img class="card-img-bottom" src="images/milky.jpg" alt="Card image cap" style="width: 230px;  margin-left: 60px;">
							</a>
						</div>
						<div class="card-body border border-top-0">
							<h5 class="blog-title card-title m-0" style="text-align: center;"><a href="#"> Crêpe </a></h5>
						</div>
					</div>
				</div> 
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="#menu.hp"> <img class="card-img-bottom" src="images/Jwejem.jpg" alt="Card image cap" style="width: 170px; margin-left: 90px;">
							</a>
						</div>
						<div class="card-body border border-top-0">
							<h5 class="blog-title card-title m-0" style="text-align: center;"><a href="#" >Jwejem</a></h5>
							</a>
						</div>
					</div>
				</div>
