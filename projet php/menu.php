...
<body>
	...
	<section class="portfolio py-5">
		<div class="container py-xl-5 py-lg-3">
		    <div>
		        <a href="create.php"><button class="btn btn-outline-success" type="submit"> Ajouter un produit </button></a>
            </div>
			<div class="container py-xl-5 py-lg-3">
...
<?php
	...
	<thead>
	<tr>
				<td><img src = "<?php echo $produitData['fichier'] ?>" style="width:300px;height:150px;border:5000px; " /></td>
                </tr>
				</thead>
	               <tbody>
			    ...
			    <tr>	  
				    <td style="text-align:center;"><?= $produitData['desc']?></td>
			    </tr>
			    ...
			    <tr>
				    ...
				    <td>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					    <a href="login.php"><button class="btn btn-outline-success" type="submit">Acheter </button></a> &nbsp;&nbsp;
					    <a href='edit.php?pid=<?= $produitData['pid'] ?>'><button type="submit" value="<?php echo $produitData['pid']?>" class="btn btn-success">Editer</button></a>  &nbsp;&nbsp;
					    <a href='delete.php?pid=<?= $produitData['pid'] ?>'><button type="submit" value="<?php echo $produitData['pid']?>" class="btn btn-danger">Supprimer</button></a>
                    </td>
				</tr>	
